...
CALYPSO_PROC CalypsoSamDigestInitCompat(CALYPSO_CTX_ST *ctx, BYTE kno, const BYTE cardresp[], CALYPSO_SZ cardrespsize)
{
  CALYPSO_RC rc;
  CALYPSO_SZ recv_len, send_len = 0;
 ...
 *
 **/
CALYPSO_PROC CalypsoSamDigestInit(CALYPSO_CTX_ST *ctx, BYTE kif, BYTE kvc, const BYTE cardresp[], CALYPSO_SZ cardrespsize)
{
  CALYPSO_RC rc;
  CALYPSO_SZ recv_len, send_len = 0;
 ...
 *
 **/
CALYPSO_PROC CalypsoSamDigestUpdate(CALYPSO_CTX_ST *ctx, const BYTE cardapdu[], CALYPSO_SZ cardapdusize)
{
  CALYPSO_RC rc;
  CALYPSO_SZ recv_len, send_len = 0;
