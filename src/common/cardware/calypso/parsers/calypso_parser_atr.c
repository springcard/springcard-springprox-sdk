...
static void  CalypsoParseAtr_TA(CALYPSO_CTX_ST* ctx, BYTE counter, BYTE T, BYTE* offset, const BYTE atr[], CALYPSO_SZ atrsize);
static void  CalypsoParseAtr_TB(CALYPSO_CTX_ST* ctx, BYTE counter, BYTE T, BYTE* offset, const BYTE atr[], CALYPSO_SZ atrsize);
static void  CalypsoParseAtr_TC(CALYPSO_CTX_ST* ctx, BYTE counter, BYTE T, BYTE* offset, const BYTE atr[], CALYPSO_SZ atrsize);
static void  CalypsoParseAtr_TD(CALYPSO_CTX_ST* ctx, BYTE counter, BYTE* offset, const BYTE atr[], CALYPSO_SZ atrsize);

static CALYPSO_RC CalypsoParseCardAtr_HistBytes(CALYPSO_CTX_ST* ctx, const BYTE data[], CALYPSO_SZ size);
#if (CALYPSO_WITH_SAM)
static CALYPSO_RC CalypsoParseSamAtr_HistBytes(CALYPSO_CTX_ST* ctx, const BYTE data[], CALYPSO_SZ size);
#endif
 ...
 *
 **/
CALYPSO_PROC CalypsoParseCardAtr(CALYPSO_CTX_ST* ctx, const BYTE atr[], CALYPSO_SZ atrsize)
{
	BYTE offset = 0;
	BYTE Y1;
	BYTE K;
 ...
 *
 **/
CALYPSO_PROC CalypsoParseSamAtr(CALYPSO_CTX_ST* ctx, const BYTE atr[], CALYPSO_SZ atrsize)
{
	BYTE offset = 0;
	BYTE Y1;
	BYTE K;
